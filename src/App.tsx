...
function App() {
    ...
    const addTodolist = (title: string, todolistId: string) => {
        ...
        let updatedTdl = [newTodolist, ...todolists]
        console.log(updatedTdl)
        setTodolists([...updatedTdl]);
        setTasks({...tasks, [todolistId]: []})
    }

    const updateTask = (title: string, id: string, todolistId: string) => {
        const clickedTask = tasks[todolistId].find(el => el.id === id)
        if (clickedTask) {
    ...
    const updateTodolist = (title: string, id: string, todolistId: string) => {
        console.log(title)
        const currentTask = todolists.find(el => el.id === todolistId)
        if (currentTask) {
